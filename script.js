document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Happy Birth Day To You🎂" },
        { time: 7, text: "Happy Birth Day To You🎂" },
        { time: 12, text: "Happy Birth Day🎂" },
        { time: 15, text: "Happy Birth Day🎂" },
        { time: 18, text: "Happy Birth Day To You🎂" },
        { time: 20, text: "Happy Birth Day To You🎂" },
        { time: 30, text: "Happy Birth Day To You🎂" },
        { time: 35, text: "Happy Birth Day🎂" },
        { time: 39, text: "Happy Birth Day🎂" },
        { time: 45, text: "Happy Birth Day To You🎂" },
        { time: 47, text: "Selamat Ulang Tahun Sayang Ku 🎂, Doa Terbaik Buat Ayang ya🤗😘. Murah Rezeki dan Jangan Lupa Sama Abg Ya Sayang ku😘. I Love U ❤️"},
    ];
